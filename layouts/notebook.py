...
createTableButton = tb.Button(tableGroup, text="Create Table", bootstyle="INFO OUTLINE", style='info.Outline.TButton', command=logic.createTableWindow)
dropTableButton = tb.Button(tableGroup, text="Delete Table", bootstyle="DANGER OUTLINE", style='danger.Outline.TButton', command=logic.dropTable)
showTableButton = tb.Button(tableGroup, text="Show Tables", bootstyle="SUCCESS OUTLINE", style='success.Outline.TButton', command=logic.showTables)
...
insertButton = tb.Button(tableGroup, text="Insert Table Item", bootstyle="INFO OUTLINE", style='info.Outline.TButton')
deleteButton = tb.Button(tableGroup, text="Delete Table Item", bootstyle="DANGER OUTLINE", style='danger.Outline.TButton')
updateTableButton = tb.Button(tableGroup, text="Update Table Item", bootstyle="INFO OUTLINE", style='info.Outline.TButton')
showButton = tb.Button(tableGroup, text="Show Table Items", bootstyle="DANGER OUTLINE", style='success.Outline.TButton')
